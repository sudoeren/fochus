  ...
  const handleSave = async () => {
    ...
    try {
      const dataToSend = {
        ...
        reminderAt: taskData.hasReminder ? taskData.reminderAt : undefined,
      ...
      if (taskData.hasReminder && taskData.reminderAt) {
        notificationService.scheduleReminder(taskData.reminderAt, () => {
          notificationService.showTaskReminder(taskData.title, taskData.dueDate ? new Date(taskData.dueDate) : undefined);
        });
      }
