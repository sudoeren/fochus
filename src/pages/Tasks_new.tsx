...
import { Plus, Calendar, Clock, CheckCircle, Circle, Edit, Trash2 } from 'lucide-react';
import { useTasks } from '../hooks/useTasks';

export const Tasks: React.FC = () => {
  const { tasks, loading, addTask, updateTask, deleteTask, toggleTask, getTasksByFilter } = useTasks();
